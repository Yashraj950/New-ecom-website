...
const ProductsData = [
  {
    ...
    title: "Causal Wear",
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quisquam eaque praesentium magnam dolore quos!",
  },
  {
    id: 2,
    img: Img2,
            ...
            >
             ...
             text-sm line-clamp-2"
                ...
                <button className="bg-primary hover:scale-105 
                 duration-300 text-white py-1 px-4 rounded-full mt-4 group-hover:bg-white group-hover:text-primary">
                    Order Now
                </button>
              </div>
            </div>
